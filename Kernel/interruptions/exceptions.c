...
void exceptionDispatcher(int ex, uint64_t *rip, uint64_t *rsp) {
  char *msg;
  switch (ex) {
    case ZERO_EXCEPTION_ID: msg = ZERO_EXCEPTION_DESCRIPTION; break;
    case OPCODE_EXCEPTION_ID: msg = OPCODE_EXCEPTION_DESCRIPTION; break;
    case GENERAL_PROTECTION_ID: msg = GENERAL_PROTECTION_DESCRIPTION; break;
    case PAGE_FAULT_ID: msg = PAGE_FAULT_DESCRIPTION; break;
  }
